...
fun MyScreen(
    ...
    Column(
        ...
        Column(
            ...
            ConditionRow(condition = "Minimum 6 character", check = passwordError.hasMinimum)
            ConditionRow(condition = "Has special character", check = passwordError.hasSpecialCharacter)
            ConditionRow(condition = "Has capitalized letter", check = passwordError.hasUppercase)
        }
    }
